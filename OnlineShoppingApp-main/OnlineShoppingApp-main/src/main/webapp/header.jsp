  ...
  <header>
        <nav>
            <ul>
                ...
                <li><a href="Helpcenter.jsp">About</a></li>
                <li><a href="Helpcenter.jsp">Services</a></li>
                <li><a href="Helpcenter.jsp">Contact</a></li>
                <li><a href="buynow.jsp">PROCEED TO CHECKOUT</a></li>
            </ul>
        </nav>
    </header>
